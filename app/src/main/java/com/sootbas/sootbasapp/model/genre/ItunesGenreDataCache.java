...
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_BUSINESS, "Business", R.drawable.business),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_SELFDEVELOPMENT, "#Develop", R.drawable.selfdevelopment),
...
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_GOVERNMENT_AND_ORGANISATIONS, "Government", R.drawable.government),
            ...
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_HEALTH, "#Nutrition", R.drawable.health),
...
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_NEWS_AND_POLITICS, "News and Politics", R.drawable.news_and_politics),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_Life, "#LifeStyle", R.drawable.lifestyle),
...
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_PLACES_AND_TRAVEL, "#Travel", R.drawable.travel),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_Women, "#Beauty", R.drawable.women),
