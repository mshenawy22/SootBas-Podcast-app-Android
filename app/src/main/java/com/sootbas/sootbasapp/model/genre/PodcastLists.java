...
public class PodcastLists {
    ...
    private ArrayList <Podcast> playlist_Podcast_list = new ArrayList<Podcast>() ;
    ...
    public PodcastLists()
    {
        ...
        playlist_Podcast_list.add(PodcastsConstants.GetMotivated_podcast);
        playlist_Podcast_list.add(PodcastsConstants.SleepMode_podcast);
        playlist_Podcast_list.add(PodcastsConstants.FeelingBored_podcast);
    ...
    public ArrayList<Podcast> getplaylist_Podcast_list() {
        return playlist_Podcast_list;
    }
