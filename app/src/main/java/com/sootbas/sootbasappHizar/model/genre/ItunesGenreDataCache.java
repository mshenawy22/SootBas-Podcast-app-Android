package com.sootbas.sootbasappHizar.model.genre;
...
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_BUSINESS, "Business", R.drawable.business),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_COMEDY, "Comedy", R.drawable.comedy),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_EDUCATION, "Self Learning", R.drawable.education),
...
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_GOVERNMENT_AND_ORGANISATIONS, "Government", R.drawable.government),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_HEALTH, "Health & Fitness", R.drawable.health),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_SELFDEVELOPMENT, "Self Development", R.drawable.selfdevelopment),
...
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_NEWS_AND_POLITICS, "News and Politics", R.drawable.news_and_politics),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_RELIGION_AND_SPIRITUALITY, "Islamic", R.drawable.religion),
...
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_SPORTS_AND_RECREATION, "Sports and Recreation", R.drawable.sports),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_TV_AND_FILM, "TV and Film Reviews", R.drawable.tv),
...
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_TECH_NEWS, "Tech News", R.drawable.tech_news),
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_MANAGEMENT_AND_MARKETING, "Management and Marketing", R.drawable.management),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_PLACES_AND_TRAVEL, "Travel Stories", R.drawable.travel),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_Books_Reviews, "Books Reviews", R.drawable.books),
            new ItunesGenre(ItunesGenreIdConstants.PODCAST_Women, "Women", R.drawable.women),
...
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_HISTORY, "History", R.drawable.history),
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_SOCIAL_SCIENCES, "Social Sciences", R.drawable.social_sciences),
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_SELF_HELP, "Self Help", R.drawable.self_help),
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_VISUAL_ARTS, "Visual Arts", R.drawable.visual_arts),
//            new ItunesGenre(ItunesGenreIdConstants.PODCAST_INVESTING, "Investing", R.drawable.investing)
